  ...
  try {
    ...
    return (
      <div className="flex flex-col gap-6 animate-fade-in">
        <div>
          <h2 className="text-xl font-bold tracking-tight text-foreground">Tarefas</h2>
        </div>
        <CompanyBlocked />
      </div>
    );
    ...
    <div className="flex flex-col gap-6 animate-fade-in">
      ...
      <SimpleTable
        ...
        columns={[
          ...
          { header: "Estado", cell: (t) => <StatusBadge domain="task" status={t.status} /> },
          {
            header: "",
            cell: (t) => <TaskRowActions taskId={t.id} currentStatus={t.status} />,
